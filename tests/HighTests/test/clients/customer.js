...
class CreateCustomer extends PrestashopClient {
  ...
  addEmailAddress() {
    return this.client
      ...
      .setValue(selector.BO.Customers.Customer.email_address_input, 'demo' + global.customer_id + '@prestashop.com')
      .pause(1000)
  }
  ...
  addCustomerEmail() {
    return this.client
      ...
      .setValue(selector.BO.Customers.addresses.email_input, 'demo' + global.customer_id + '@prestashop.com')
      .pause(1000)
  }
