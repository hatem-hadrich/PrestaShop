scenario('Create customer', client => {
  ...
  test('should go to customer menu', () => client.goToCustomers());
  ...
  test('should new customer', () => client.saveCustomer());
  test('should check added customer success panel', () => client.successPanel('Successful creation.'));
